...
|--------|---------|--------|--------|----------------------|
| **plsql-analyzer** | v4.26 | 889 | 700 ⚠️ | Skip inteligente objetos existentes + captura completa types + variables públicas/privadas |
...
- **plsql-analyzer v4.26:** 889 líneas (+27% sobre target de 700)
  - **Justificación:** Funcionalidad crítica para migración efectiva
    ...
    - Variables públicas (SPEC) + privadas (BODY) explícitamente en Schema A
    - Dos schemas adaptativos (PACKAGE_BODY vs PROCEDURE/FUNCTION)
    - Cinco ejemplos necesarios (casos de uso distintos)
  - **Optimización histórica:** 1214 → 977 (-19.5%) → 1037 (v4.21) → 1024 (v4.23) → 878 (v4.24) → 876 (v4.25) → 889 (v4.26 +private_vars)
...
12. **v4.26:** plsql-analyzer - Agregado private_variables a Schema A (package_spec_context)
...
- **Versiones actuales:** plsql-analyzer v4.26, plsql-converter v4.3.1, plpgsql-validator v3.2.1
